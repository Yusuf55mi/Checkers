...
import { WeightedVoteOption } from "alice-checkers-client-ts/cosmos.gov.v1/types"
import { Deposit } from "alice-checkers-client-ts/cosmos.gov.v1/types"
import { Proposal } from "alice-checkers-client-ts/cosmos.gov.v1/types"
import { TallyResult } from "alice-checkers-client-ts/cosmos.gov.v1/types"
import { Vote } from "alice-checkers-client-ts/cosmos.gov.v1/types"
import { DepositParams } from "alice-checkers-client-ts/cosmos.gov.v1/types"
import { VotingParams } from "alice-checkers-client-ts/cosmos.gov.v1/types"
import { TallyParams } from "alice-checkers-client-ts/cosmos.gov.v1/types"
import { Params } from "alice-checkers-client-ts/cosmos.gov.v1/types"
